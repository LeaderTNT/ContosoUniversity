...
namespace ContosoUniversity.Controllers
{
    public class InstructorController : Controller
    {
        ...
        public ActionResult Edit(int? id)
        {
            ...
            Instructor instructor = db.Instructors.Include(i => i.OfficeAssignment).Include(i => i.Courses).Single(i => i.ID == id);
            PopulateAssignedCourseData(instructor);
        ...
        public ActionResult EditPost(int? id, string[] selectedCourses)
        {
            ...
            var instructorToUpdate = db.Instructors.Include(i => i.OfficeAssignment).Include(i => i.Courses).Single(i => i.ID == id);
